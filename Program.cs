	...
	public class Program
	{
		...
		static class Circle
		{
			...
			public static void Position(double Radius, double positionX, double positionY)
			{
				...
				{
					Console.WriteLine("Точка с координатами ({0},{1}) находится внутри круга радиуса {2}", positionX, positionY, Radius);
				}
				else
				{
					Console.WriteLine("Точка с координатами ({0},{1}) находится вне круга радиусом {2}", positionX, positionY, Radius);
				}
				Console.ReadKey();
			}
		}
